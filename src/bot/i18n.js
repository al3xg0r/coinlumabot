...
Need help? Contact @agtsupbot`,
    ...
    support_info: '📬 <b>Support</b>\n\nIf you need assistance, please contact our support bot: @agtsupbot',
...
Нужна помощь? Обратитесь к @agtsupbot`,
    ...
    support_info: '📬 <b>Поддержка</b>\n\nЕсли вам нужна помощь, обратитесь к нашему боту поддержки: @agtsupbot',
...
Потрібна допомога? Зверніться до @agtsupbot`,
    ...
    support_info: '📬 <b>Підтримка</b>\n\nЯкщо вам потрібна допомога, зверніться до нашого бота підтримки: @agtsupbot',
